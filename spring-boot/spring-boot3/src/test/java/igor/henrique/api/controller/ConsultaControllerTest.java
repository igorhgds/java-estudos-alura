...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver código http 400 quando as informações estão invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver código http 200 quando as informações estão validas")
    @WithMockUser
